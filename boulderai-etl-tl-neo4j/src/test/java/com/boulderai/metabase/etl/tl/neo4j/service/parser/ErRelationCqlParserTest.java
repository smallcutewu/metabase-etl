...
public class ErRelationCqlParserTest extends SpringBaseTest {
    ...
    public void testParseInsertCql()
    {
        ...
        ErRelationCqlParser  parser=new ErRelationCqlParser();
        ...
        cql=parser.parseDeleteModelDataCql(tableToBeanConfig,record);
        Assert.assertNotNull(cql);
    }
}
